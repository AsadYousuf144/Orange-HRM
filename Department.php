    ...
    <div id="sub-header">
		<h2>Department</h2>
				...
				<fieldset>
					...
					<form action="input department submit.php" method="POST">
					
                    <p><label for="id">Department Id:</label>
						<input name="did" id="id"  type="text"  placeholder = "" required  /><br /></p>	
						
						<p><label for="id">Employee Id:</label>
						<input name="eid" id="id"  type="text"  placeholder = "" required  /><br /></p>
						
						<p><label for="id">Department Name:</label>
						<input name="name" id="Name"  type="text"  placeholder = "" required  /><br /></p>
						
												
		
						<p><label for="name">Location:</label>
						<input name="location" id="name"  type="text" required /><br /></p>

                        <p><input name="Submit" class="formbutton" value="Submit" type="submit" />
					</form>
				</fieldset>
