    ...
    <div id="sub-header">
		<h2>Add User</h2>
				...
				<fieldset>
					...
					<form action="input add user.php" method="post">
					
                    <p><label for="id">User ID:</label>
						<input name="id" id="id"  type="text"  placeholder ="Enter your id" required  /><br /></p>	
						
						<p><label for="name">User Name:</label>
						<input name="name" id="name" placeholder = "Enter your name" type="text" required /><br /></p>	
						
						<p><label for="Password">Password:</label>
						<input name="Password" id="Password" placeholder=Password type="text" required /><br /></p>
						
                       <p><label for="User_type">User_type:</label>
                       <input name"User_type" type"list" required>
